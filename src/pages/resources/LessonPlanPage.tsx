...
const flow = [
  ...
  ['활동 1', '10분', '생활 속 사례 8개를 제시하고 각 기능을 예상하도록 안내한다.', '활동지 사례표를 살펴보고 추천·인식·분류·자동 기계 중 하나를 예상한다.', 'PPT 3~6, 활동지', '센서와 알람처럼 정해진 조건에 반응하는 사례를 함께 비교한다.'],
  ['활동 2', '15분', '추천·인식·분류의 뜻과 자동 기계의 특징을 설명하고 활동지 사례표를 완성하게 한다.', '8개 사례를 네 가지 기능으로 구별해 기록하고 짝과 판단 근거를 이야기한다.', 'PPT 7~11, 활동지', '기능 이름을 외우기보다 데이터의 특징을 이용한다는 공통점에 주목한다.'],
  ['활동 3', '7분', '자동 기계와 AI가 결과를 정하는 방식을 비교하여 핵심 문장을 완성하게 한다.', '정해진 조건·규칙과 데이터의 특징·관계를 사용해 차이를 설명한다.', 'PPT 12~14, 활동지', '모든 첨단 기기나 인터넷 연결 기기가 AI인 것은 아님을 강조한다.'],
  ['정리', '3분', '핵심 질문에 다시 답하고 새롭게 알게 된 점을 한 문장으로 정리하게 한다.', 'AI와 자동 기계의 차이를 근거와 함께 말하고 성찰 문장을 작성한다.', 'PPT 15, 활동지', '다음 차시의 옛이야기 선정 활동을 예고한다.'],
];
    ...
    <main className="print-page-wrap">
      ...
      <article className="print-sheet lesson-plan-sheet">
        ...
        <section className="assessment-grid">
          <div><h2>평가 관점</h2><p>AI와 자동 기계를 근거와 함께 구별하는가?</p><p>추천·인식·분류를 알맞은 사례와 연결하는가?</p><p>두 방식의 차이를 핵심 낱말로 설명하는가?</p></div>
