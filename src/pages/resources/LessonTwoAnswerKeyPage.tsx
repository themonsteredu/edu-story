    ...
    <main className="print-page-wrap lesson-two-print-wrap">
      ...
      <article className="print-sheet lesson-two-answer-sheet">
        ...
        <section className="lesson-two-teacher-guidance">
          <div><h2>허용 답</h2><p>각 장면에서 표정·시간·주변 모습·중요한 물건·소리 중 어느 것을 골라도 됩니다. 고른 까닭을 장면과 연결해 말하면 인정합니다.</p></div>
          <div><h2>추가 발문</h2><p>“이 사건이 앞에 와야 하는 까닭은 무엇일까?”, “AI가 이 장면을 이해하려면 무엇을 더 알려줘야 할까?”</p></div>
