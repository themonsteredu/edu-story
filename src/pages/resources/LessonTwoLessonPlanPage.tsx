...
const flow = [
  ...
  ['활동 1', '5분', '세 가지 고정 옛이야기를 제시하고 선택한 이야기를 함께 읽는다.', '모둠에서 만들 이야기 하나를 고르고 고정 읽기 자료를 읽는다.', 'PPT 4, 읽기 자료', '긴 토론보다 까닭을 한 번씩 말하고 선택하게 한다.'],
  ['활동 2', '5분', '선택한 이야기에 나오는 인물과 배경 낱말을 안내한다.', '알맞은 인물·배경 낱말을 누르거나 ○표한다.', 'PPT 5~6, 활동지', '글쓰기 없이 선택 결과와 말하기로 이해를 확인한다.'],
  ['활동 3', '10분', '섞인 사건 여섯 개를 읽고 원인과 결과를 살피도록 돕는다.', '사건 카드를 먼저 일어난 일부터 옮기고 순서를 확인한다.', 'PPT 7~10, 웹앱', '드래그가 어려우면 앞·뒤 버튼을 사용하게 한다. 점수와 시간 제한을 두지 않는다.'],
  ['활동 4', '12분', '같은 사건도 인물·장소·느낌·모습을 다르게 기획할 수 있음을 예로 보여준다.', '각 장면에서 누가, 어디서, 어떤 느낌과 모습으로 나올지 구체적인 낱말을 고른다.', 'PPT 11~12, 웹앱', '교사가 답을 정하지 않는다. 학생의 선택이 사건과 자연스럽게 연결되는지만 살핀다.'],
  ['정리', '3분', '사건 순서와 학생의 장면 기획을 구분해 정리한다.', '자신이 기획한 여섯 장면 가운데 한 장면을 친구에게 소개한다.', 'PPT 13', '긴 글쓰기 대신 고른 낱말을 활용해 말하게 한다.'],
];
      ...
      <article className="print-sheet lesson-two-plan-sheet">
        ...
        <section className="plan-goal-box">
          ...
          <ol>
            ...
            <li>각 사건을 그림으로 나타낼 때 필요한 인물·장소·느낌·모습을 직접 기획할 수 있다.</li>
          </ol>
        </section>
        ...
        <section className="assessment-grid">
          <div><h2>관찰 평가</h2><p>인물·배경을 알맞게 고르는가?</p><p>여섯 사건의 흐름을 배열하는가?</p><p>사건에 어울리는 장면 모습을 스스로 고르고 설명하는가?</p></div>
          <div><h2>준비물</h2><p>교사용 PPT, 교사가 검토한 고정 이야기 읽기 자료, 태블릿 또는 활동지, 필기구</p></div>
          <div><h2>수업 원칙</h2><p>생성형 AI를 실행하지 않는다. 사건 순서만 확인하며 장면 기획에는 하나의 정답을 두지 않는다.</p></div>
        </section>
